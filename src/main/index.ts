...
import { setIpcMain } from '@bharat-browser/rpc-electron';
setIpcMain(ipcMain);
...
export const isNightly = app.name === 'bharat-browser-nightly';

app.allowRendererProcessReuse = true;
app.name = isNightly ? 'bharat-browser Nightly' : 'bharat-browser';
